package br.com.avila.data.dto.security;
...
public class TokenDTO implements Serializable {
    ...
    public TokenDTO(String username, Boolean authenticad, Date created, Date expiration, String accessToken, String refreshToken) {
