package br.com.avila.integrationtests.controllers.cors.withjson;


import br.com.avila.config.TestConfigs;
import br.com.avila.integrationtests.dto.*;
...
class PersonControllerCorsTest extends AbstractIntegrationTest {
    ...
    void createWithWrongOrigin() throws JsonProcessingException {
        ...
        specification = new RequestSpecBuilder()
                .addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_AVILA)
                .addHeader(TestConfigs.HEADER_PARAM_AUTHORIZATION, "Bearer " + tokenDto.getAccessToken())
                .setBasePath("/api/person/v1")
                .setPort(TestConfigs.SERVER_PORT)
                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
